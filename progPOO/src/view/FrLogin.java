...
public class FrLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbllUsuario.setFont(new java.awt.Font("Yu Gothic", 0, 11)); // NOI18N
        lbllUsuario.setText("Usuario");
        pnlPrincipal.add(lbllUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(79, 119, -1, -1));

        lblsenha.setFont(new java.awt.Font("Yu Gothic", 1, 11)); // NOI18N
        lblsenha.setText("Senha");
        pnlPrincipal.add(lblsenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(79, 183, -1, -1));

        edtUsuario.setFont(new java.awt.Font("Yu Gothic", 0, 12)); // NOI18N
        edtUsuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                edtUsuarioActionPerformed(evt);
            }
        });
        pnlPrincipal.add(edtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(79, 135, 216, -1));

        edtSenha.setFont(new java.awt.Font("Yu Gothic", 0, 12)); // NOI18N
        pnlPrincipal.add(edtSenha, new org.netbeans.lib.awtextra.AbsoluteConstraints(79, 203, 216, -1));

        btnEntrar.setFont(new java.awt.Font("Yu Gothic", 1, 12)); // NOI18N
        btnEntrar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/9040536_key_icon (1).png"))); // NOI18N
        ...
        pnlPrincipal.add(lblLogin, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 50, -1, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/userIcon.png"))); // NOI18N
        pnlPrincipal.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 30, 50, 70));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 356, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlPrincipal, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
        );
